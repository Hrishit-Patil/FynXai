...
const auditLogs = [
  ...
  },
  {
    ...
    user: "admin@platform.com",
    action: "User created: newuser@platform.com",
    type: "user",
  },
  {
...
export default function AdminDashboard() {
  ...
  const fetchFeedbackStats = async () => {
    try {
      ...
      if (data) {
        ...
        const notHelpful = data.filter(
          (item) => item.is_helpful === false,
        ).length;
        setFeedbackStats({
          helpful,
          notHelpful,
  ...
  const pieData = [
    { name: "Helpful", value: feedbackStats.helpful, color: "#22c55e" },
    {
      ...
      value: feedbackStats.notHelpful,
      color: "#ef4444",
    },
  ];
  ...
  const notHelpfulPercent =
    feedbackStats.total > 0
      ? Math.round((feedbackStats.notHelpful / feedbackStats.total) * 100)
      : 0;
    ...
    <div className="min-h-screen bg-muted/30 p-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        >
          <Card>
            <CardHeader>
              <CardTitle>System Loan Applications</CardTitle>
            </CardHeader>
            <CardContent>
                        ...
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            {officer.deletion_requested && (
                              <Badge
                                variant="destructive"
                                className="h-5 text-[10px] uppercase animate-pulse"
                              >
                                Deletion Requested
                              </Badge>
                            )}
                            ...
                            <TableCell className="align-top">
                              <div className="flex items-center gap-2 mb-3">
                                <Badge
                                  ...
                                  className={
                                    isClosed
                                      ? "bg-red-100 text-red-700 border-transparent hover:bg-red-200 dark:bg-red-900/30 dark:text-red-400"
                                      : "bg-blue-100 text-blue-700 border-transparent hover:bg-blue-200 dark:bg-blue-900/30 dark:text-blue-400"
                                  }
                                >
                                ...
                                {!isClosed && (
                                  <Button
                                    ...
                                    onClick={() =>
                                      handleCloseSupportRequest(req.id)
                                    }
                                  >
                              ...
                              {req.evidence_path && (
                                <Button
                                  ...
                                  onClick={() =>
                                    handleViewSupportDocument(req.evidence_path)
                                  }
                                >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 bg-muted/50 p-4 rounded-lg border">
                ...
                <div>
                  ...
                  <p className="font-mono text-sm mt-1 text-primary">
                    {selectedTicket.application_id || "Not Provided"}
                  </p>
                </div>
                <div>
                  <Label className="text-xs text-muted-foreground uppercase tracking-wider">
                ...
                <div>
                  ...
                  {selectedTicket.phone && (
                    <p className="text-sm mt-0.5">{selectedTicket.phone}</p>
                  )}
                </div>
                <div>
                  <Label className="text-xs text-muted-foreground uppercase tracking-wider">
              ...
              {selectedTicket.evidence_path && (
                <div className="pt-4 border-t">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      handleViewSupportDocument(selectedTicket.evidence_path)
                    }
                  >
